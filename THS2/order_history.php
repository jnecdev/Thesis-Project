...
?>
	<img src="images/header.jpg"/><br/><Br/>
		...
		<div id="container">
			<div id="upper-tab">
				<div id="crud-item">
					<div class="tab-cont">Order History</div>
					<div class="tab-cont"><a href="<?php Print "pendingorders.php?token=$token&id=$user"; ?>">Pending Orders</a></div>
					<?php
				...
				<?php
					...
					while($row = mysql_fetch_assoc($query)){
						...
						if($len == 1){
							...
							Print '<TD Align = "Center">'.$row['lead_time'].'</TD>';
