...
?>
	<img src="images/header.jpg"/><br/><Br/>
		...
		<div id="container">
			<div id="upper-tab">
				<div id="crud-item">
					<div class="tab-cont"><a href="report.php">Report</a></div>
					<div class="tab-cont">Damaged Items List</div>
					<?php

					include 'config.php';

					$query = mysql_query("Select * FROM damaged_items");
			...
			<div id="item-names">
				...
				<?php
					...
					$query = mysql_query("Select * from damaged_items LIMIT $start, 10");
					while($row = mysql_fetch_assoc($query)){
						...
						if($len == 1){
							...
							Print '<TD Align = "Center">'.$row['part_damaged'].'</TD>';
